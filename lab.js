...
/*
  ...
  Amy or Brittani is older, and then console.log '{name} is older'. 
...
/*
  ...
  of clothes one should wear for the day, based on the above temperature and rain. If it is 80 degrees or 
  above, and raining, one should wear a t-shirt and take an umbrella. If it is between 60 and 80 degrees, and raining, 
  one should wear a rain-jacket. If it is 60 degrees or below, one should wear a jacket and carry an umbrella. Come up 
  with your own clothing suggestions based on those temperature parameters when it is not raining.
*/
...
if (rain == true, temperature >= 80){
  ...
  console.log("ne should wear a t-shirt")
} else if (rain == false, 60 < temperature < 80){
  console.log("one should wear a two t-shirts")
} else if (rain == false, temperature <= 60){
  console.log("one should wear a three t-shirts")
} 
//  ((temperature < 80 && rain == true) || (temperature < 80 && rain == true))
...
while (score < passingScore){
  score ++
  console.log(score, ": our score is not high enough")
}
